						...
						<div class="detail pannel-footer">
							...
							<div class="col-md-7 col-sm-7">
								<div class="detail-pannel-footer-btn pull-right">
									<a href="{{route('vieclam.create')}}" class="footer-btn grn-btn" title="">Tạo Việc Làm</a>
									<a href="{{route('nhatuyendung.create')}}" class="footer-btn blu-btn" title="">Chỉnh Sửa Thông Tin</a>
								</div>
							</div>
